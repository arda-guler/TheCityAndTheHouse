...
def drawPoint2D(x, y, color, camera):
    ...
    glVertex3f((x1) * camera.get_textmtx()[0][0] + (y1) * camera.get_textmtx()[1][0] + (-1000) * camera.get_textmtx()[2][0],
               (x1) * camera.get_textmtx()[0][1] + (y1) * camera.get_textmtx()[1][1] + (-1000) * camera.get_textmtx()[2][1],
               (x1) * camera.get_textmtx()[0][2] + (y1) * camera.get_textmtx()[1][2] + (-1000) * camera.get_textmtx()[2][2])
...
def drawLine2D(x1, y1, x2, y2, color, camera):
    ...
    glVertex3f((x2) * camera.get_textmtx()[0][0] + (y2) * camera.get_textmtx()[1][0] + (-1000) * camera.get_textmtx()[2][0],
               (x2) * camera.get_textmtx()[0][1] + (y2) * camera.get_textmtx()[1][1] + (-1000) * camera.get_textmtx()[2][1],
               (x2) * camera.get_textmtx()[0][2] + (y2) * camera.get_textmtx()[1][2] + (-1000) * camera.get_textmtx()[2][2])
    glEnd()
    glPopMatrix()
